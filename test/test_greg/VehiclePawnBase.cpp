...
void AVehiclePawnBase::initialize()
{
	...
	initial_state_.passthrough_enabled = true; // GMG - Added this to allow passthrough for simSetPose to reset vehicle position without getting stuck on objects
...
void AVehiclePawnBase::allowPassthroughToggleInput()
{
	...
	state_.passthrough_enabled = true;
